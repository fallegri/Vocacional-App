// ===========================================================================
// Formulario de registro / reenvío de verificación.
//
    ...
    return (
      <main style={{ maxWidth: 420, margin: "60px auto", padding: "0 16px" }}>
        ...
        <p style={{ fontSize: 14, color: "#6B7280", marginTop: 12, lineHeight: 1.6 }}>
          Si el correo no llega en 5 minutos, revisa tu carpeta de spam. Si
          estás en modo de prueba con Resend (usando onboarding@resend.dev), el
          correo solo llega al correo verificado en tu cuenta Resend; para
          enviar a cualquier correo debes verificar un dominio en{" "}
          <a href="https://resend.com/domains" style={{ color: "#4F46E5" }}>
            resend.com/domains
          </a>
          .
        </p>
